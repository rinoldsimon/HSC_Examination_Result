...
<body bgcolor="#e6ffe5">
<center>
<h1><b><font color="green"><p class="small"><%out.print(request.getParameter("college")); %></p></font></b></h1>
...
try {
	...
	String query4="select col_name,course,"+category+" from coll_data where col_name='"+col+"'";
		rs=st.executeQuery(query4);
		while(rs.next()){
			%>
			<tr><td>&nbsp;<font color="blue"><%out.print(rs.getString(2)); %></font></td>
			<td>&nbsp;<font color="red"><%out.print(rs.getString(3)); %></font></td>
